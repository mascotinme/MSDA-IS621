...
training <- read.csv("C:/Users/mayowa/Downloads/moneyball-training-data.csv", header = TRUE, sep = ",")

evaluation <- read.csv("C:/Users/mayowa/Downloads/moneyball-evaluation-data.csv", header = TRUE, sep = ",")
